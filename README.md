...
Key Findings
•	Multi-Parameter Assessment: Successfully tracked five critical oceanographic indicators: Chlorophyll-a, Sea Surface Temperature (SST), Turbidity (Kd_490), Particulate Organic Carbon (POC), and Particulate Inorganic Carbon (PIC).
...
Study Methodology
•	Data Acquisition & Automation: Automated retrieval of 10 years of MODIS Level-2 satellite imagery via Python’s earthaccess library and NASA’s OceanColor Web.
•	Image Processing & Validation: Leveraged NASA SeaDAS for atmospheric correction, cloud masking, and rigorous data validation.
•	Integrated Analytics: Combined statistical, geospatial, and time-series analysis to understand seasonal fluctuations and long-term environmental trends.
•	Predictive Modeling: Developed a machine learning pipeline using the Random Forest method to correlate environmental variables with potential fish aggregation.
Repository Contents
•	Python Scripts: Automated data downloading, cleaning, and multi-parameter visualization.
...
•	Real-Time Integration: Integrating real-time fish catch records to further refine model accuracy.
